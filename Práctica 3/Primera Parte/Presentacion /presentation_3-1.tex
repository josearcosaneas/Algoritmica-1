...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textbf{Función solución}: Cuando el conjunto de candidatos este vació y aún tengamos fertilizante.
		...
		\item \textbf{Función objetivo}: Lista con los días que el granjero ira a la tienda.		
	\end{itemize}
